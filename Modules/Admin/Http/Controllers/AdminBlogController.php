...
class AdminBlogController extends AdminBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin::blog.list')->with($viewData);
    }
    ...
    public function create(Request $request)
    {
        ...
        $viewData = [
            'category' => [],
            'allListCategory' => $this->categoryRepository->getAllCategory($fields, 0, $filter)
        ];
        return view('admin::blog.add')->with($viewData);
    }
