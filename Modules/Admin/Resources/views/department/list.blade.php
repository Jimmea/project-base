...
<div class="row mb-3">
    <div class="col-md-12">
        ...
        <form class="form-inline" method="POST" action="{{ route('departments.store') }}">
            {{ csrf_field() }}
        ...
        <form class="form-inline" action="{{ route('departments.index') }}">
            <label class="sr-only" for="inlineFormInputName2">ID</label>
            <input type="text" class="form-control mb-2 mr-sm-2" name="department_id" placeholder="ID" value="{{array_get($quering, 'department_id')}}">
    ...
    <div class="col-md-12">
        <div class="table-responsive">
                ...
                <tbody>
                    @foreach($listDepartment as $item)
                        <tr>
                            ...
                            <td>
                                <a href="" class="btn btn-outline-secondary btn-sm"><i class="fa fa-edit"></i> Edit categories</a>
            ...
            {{ $listDepartment->appends($quering)->render() }}
