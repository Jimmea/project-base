<footer class="mt-5">
    <div class="footer__wrapper container">
        <div class="row">
            <div class="col-7">
                <a href="/">
                    <svg xmlns="http://www.w3.org/2000/svg" class="shop-logo shop-logo--white pts" style="fill: #fff;width: 200px;height: 30px;">
                ...
                <p style="color: #f2f2f2;font-weight: 300">
                    Phone: 0973366936 <br>
                    Facebook: shophoaithu.facebook.com <br>
                    Địa chỉ: 342 Khương Đình, Thanh Xuân Hà Nội <br>
                    Tài khoản ngân hàng: 097238237237237
                </p>
            </div>
        </div>
    </div>
